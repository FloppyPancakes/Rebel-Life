...
switch (_code) do
{
	...
	case 2:
	{
		["1"] execVM "flop\Scripts\flp_playerClasses.sqf";
	};

	case 3:
	{
		["2"] execVM "flop\Scripts\flp_playerClasses.sqf";
	};

	case 4:
	{
		["3"] execVM "flop\Scripts\flp_playerClasses.sqf";
	};
	...
	case 7:
	{
		[] execVM "flop\core\shops\flp_virtMenu.sqf";
	};
