...
switch (_var) do
{
	...
	case "life_inv_storage2": {"Medium Storage"};
	case "life_inv_storage3": {"Large Storage"};

	//Flop Base Building.
	case "life_inv_HBarrier_1_F": {"H-Barrier 1"};
	case "life_inv_HBarrier_3_F": {"H-Barrier 3"};
	case "life_inv_HBarrier_5_F": {"H-Barrier 5"};
	case "life_inv_HBarrierTower_F": {"H-Barrier Bunker"};
	case "life_inv_HBarrierWall_corner_F": {"H-Barrier Corner Wall"};
	case "life_inv_HBarrierWall_corridor_F": {"H-Barrier Corridor"};
	case "life_inv_HBarrierWall4_F": {"H-Barrier Wall 4"};
	case "life_inv_HBarrierWall6_F": {"H-Barrier Wall 6"};
	case "life_inv_Razorwire_F": {"Razorwire"};
	case "life_inv_Cargo_Patrol_V1_F": {"Outpost Tower"};
	case "life_inv_CamoNet_BLUFOR_F": {"Camo Net, Closed"};
	case "life_inv_CamoNet_BLUFOR_open_F": {"Camo Net, Open"};
	case "life_inv_CamoNet_BLUFOR_big_F": {"Large CamoNet 1"};
	case "life_inv_CamoNet_BLUFOR_Curator_F": {"Large CamoNet 2"};
	case "life_inv_CamoNet_BLUFOR_big_Curator_F": {"Large CamoNet 3"};
	case "life_inv_BarGate_F": {"Bar Gate"};
	case "life_breaching_charge": {"Breaching Charge"};
