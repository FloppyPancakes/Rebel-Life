...
class apex_shop
{
	...
	class controlsBackground
	{
		...
		{
			idc = 39402;
			onLBSelChanged = "_this call life_fnc_apexShopFilter";
			x = 0.11; y = 0.64;
			w = 0.3; h = 0.035;
		};
	};
	...
	class controls
	{
		...
		{
			idc = 39403;
			onLBSelChanged = "_this call life_fnc_apexShopSelection";
			sizeEx = 0.035;
			x = 0.11; y = 0.25;
			w = 0.3; h = 0.38;
		};
		...
		class ButtonBuySell : Life_RscButtonMenu
		{
			idc = 39405;
			text = "$STR_Global_Buy";
			onButtonClick = "[] call life_fnc_apexShopBuySell";
			x = 0.1 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.8 - (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
		...
		class ButtonClose : life_RscButtonMenu 
		{
			idc = -1;
			text = "$STR_Global_Close";
			onButtonClick = "closeDialog 0, deleteVehicle buy_preview;";
			x = 0.1;
			y = 0.8 - (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
