...
player createDiarySubject ["links","Download Links"];
		...
		[
			"Custom Change Log",
				"
					...
					v3.2.6: Full Player Inventory Saving. All gear lost upon death.<br/>
					v3.2.5: New Federal Reserve Added. New Location, Requires breaching. Must be locked by cops.<br/>
					v3.2.4: Barricades Shop and Construction Added<br/>
					v3.2.3: JSRS 2.1, Blastcore A3, and VTS Weapon Resting keys Added<br/>
					V3.2.2: Prostitution Added: By Floppy Pancakes<br/>
					V3.2.1: Fast Roping Added: By [STELS]Zealot<br/>
					V3.2.0: IgiLoad Logistics Added: By Igi_PL<br/>
				"
		]
	];

	player createDiaryRecord["links",
		[
			"Download Links",
				"
					Below are download links for addons we use.<br/>
					If you use ANY of these, you must have CBA. All are recommended for the best experience.<br/>
					(CBA: Required) http://goo.gl/yeCqFS<br/>
					(VTS: Weapon Resting) http://goo.gl/RXJfwW<br/>
					(JSRS2.1: Sound Mod) http://goo.gl/YzjUJz<br/>
					(Blastcore A3-R3: Visual FX Mod) http://goo.gl/U9bWbr<br/>
	...
	player createDiaryRecord ["serverrules",
		[
			"Bannable Offenses",
				...
				5. Constructing Barricades in a city WITHOUT the immediate intent to take it over.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"Arresting and Ticketing",
				...
				4. Prostitution is illegal. If someone is caught using, or trafficking prostitutes, they are subject to a fine of 35k Per Prostitute.<br/><br/>
